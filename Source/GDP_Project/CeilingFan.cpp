...
ACeilingFan::ACeilingFan()
{
	...
	CeilingFanMeshComponent = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("CeilingFanCylinderMeshComponent"));
	...
	CeilingFanMeshComponent->SetRelativeLocation(FVector(0.0f, 0.0f, -20.0f));
